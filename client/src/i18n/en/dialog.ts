const dialogTrans = {
  ...
  manageMmapTitle: `Manage MMap settings`,
  ...
  editMmapInfo: `In Milvus, memory-mapped files allow for direct mapping of file contents into memory. This feature enhances memory efficiency, particularly in situations where available memory is scarce but complete data loading is infeasible. Select the fields and indexes you want to manage mmap settings for. <br /><br />Note: The mmap settings will only take effect after the collection is loaded.`,
};
